...
We base our $\alpha$ and $\beta$ on earlier research of Blei which recommends that $\alpha = 50/T$ with $\beta = 0.01$ which show to work great with many different corpus.
