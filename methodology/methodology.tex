...
In this chapter we explain the preprocessing and approach on training the model. In  section \ref{methodology:Text preprocessing}, all the steps described in the text mining and processing of our data. The 
